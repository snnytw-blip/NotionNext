...
const SignInButton = ({children}) => <>{children}</>; const SignedOut = ({children}) => <>{children}</>; const UserButton = () => null; // import { SignInButton, SignedOut, UserButton } from '@clerk/nextjs'
