...
const SignInButton = ({children}) => <>{children}</>; const SignedIn = ({children}) => null; const SignedOut = ({children}) => <>{children}</>; const UserButton = () => null; // import { SignInButton, SignedIn, SignedOut, UserButton } from '@clerk/nextjs'
