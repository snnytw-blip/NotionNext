const CONFIG = {
  // 首屏信息栏按钮文字
  MAGZINE_HOME_BANNER_ENABLE: true, // 最初の画面の右上のプロモーション枠
  MAGZINE_HOME_BUTTON: true,
  MAGZINE_HOME_BUTTON_URL: '/about',
  MAGZINE_HOME_BUTTON_TEXT: '了解更多',

  MAGZINE_HOME_HIDDEN_CATEGORY: '分享杂文', // ホームページに表示したくない記事カテゴリ。カンマで区切ります。

  MAGZINE_HOME_TITLE: '今すぐオンラインビジネスを始めましょう。完全に無料です。',
  MAGZINE_HOME_DESCRIPTION:
    'NotionNext を活用して、ビジネスの開始、運営、拡大に必要なすべてのツールとサポートを手に入れましょう。',
  MAGZINE_HOME_TIPS: 'AI 時代の到来、これは個人の力を最大化するチャンスです！',
